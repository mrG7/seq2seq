...
options = {
    ...
    'learn_rate': 0.0007,  # initial learn rate corresponing top global step 0, or max lr for Adam
    'decay_rate': 0.95,
    'num_decay_steps': 5000,
    'ss_prob': 0.00,  # scheduled sampling probability for training. probability of passing decoder output as next
    # decoder input instead of ground truth

    'restore': True,  # boolean. restore model from disk
    'restore_model': "/data/mat10/MSc_Project/Models/model_2_cl_0state_train/m2_pretrain_2x3_0state_cl_ss000_era3_epoch3_step4999",  # path to model to restore


    'save': True,  # boolean. save model to disk during current era
    'save_model': "/data/mat10/MSc_Project/Models/model_2_cl_0state_train/m2_pretrain_2x3_0state_cl_ss000_era4",
...
model.train(sess, reset_global_step=True)
