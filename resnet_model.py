...
# def backend_resnet(x_input, resnet_size=34, num_classes=512, name="resnet", return_vector=True):
...
#         features = resnet.__call__(video_input, training=True, return_vector=return_vector)
