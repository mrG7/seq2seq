...
options = {
    ...
    'num_epochs': 20,  # number of epochs over dataset for training
    'start_epoch': 10,  # epoch to start
    ...
    'restore_model': "/data/mat10/MSc_Project/Models/model_2_train/m2_train_ss000_0state_norm_era1_epoch10_step619",  # path to model to restore


    'save': True,  # boolean. save model to disk during current era
    'save_model': "/data/mat10/MSc_Project/Models/model_2_train/m2_train_ss000_0state_norm_era2",
