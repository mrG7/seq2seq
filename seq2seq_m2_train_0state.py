...
options = {
    ...
    'batch_size': 8,   # number of examples in queue either for training or inference
    ...
    'ss_prob': 0.1,  # scheduled sampling probability for training. probability of passing decoder output as next
