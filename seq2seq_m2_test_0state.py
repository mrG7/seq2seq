...
options = {
    ...
    'restore_model': "/data/mat10/MSc_Project/Models/model_2_0state_train/m2_train_ss000_era2_epoch19_step4159",  # path to model to restore


    'save': False,  # boolean. save model to disk during current era
    'save_model': "/data/mat10/MSc_Project/Models/model_2_0state_train/m2_train_ss000_era3",
