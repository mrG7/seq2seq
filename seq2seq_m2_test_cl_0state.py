...
options = {
    ...
    'data_dir': "pretrain_random_2x3words_1",  # data paths file is in ~/Paths, named <data_dir> + "_data_info_tfrecords.csv"

    'batch_size': 12,   # number of examples in queue either for training or inference
    'frame_size': 118,  # spatial resolution of frames saved tfrecords files
    'crop_size': 112,  # spatial resolution of inputs to model
    'random_crop': False,  # boolean. if True a random elif False a center crop_size window is cropped
    ...
    'norm_attention_layer': False,  # whether to normalize the activations of the attention layer 
    'num_hidden_out': 256,  # number of hidden units in output fcn

    'beam_width': 29,  # number of best solutions used in beam decoder
    ...
    'restore_model': "/data/mat10/MSc_Project/Models/model_2_cl_0state_train/m2_pretrain_2x3_0state_cl_ss000_era1_epoch2_step6839",  # path to model to restore


    'save': False,  # boolean. save model to disk during current era
    'save_model': "/data/mat10/MSc_Project/Models/model_2_cl_0state_train/m2_pretrain_2x3_0state_cl_ss000_era2",
